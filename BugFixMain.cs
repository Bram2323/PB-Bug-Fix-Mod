...
namespace BugFixMod
{
    ...
    public class BugFixMain : PolyTechMod
    {

        public const string pluginGuid = "polytech.bugfixmod";

        public const string pluginName = "Bug Fix Mod";
        ...
        public static BugFixMain instance;


        void Awake()
        {
            if (instance == null) instance = this;
            repositoryUrl = "https://github.com/Bram2323/PB-Bug-Fix-Mod/";
        ...
        void Update()
        {
            ...
            if (!Input.GetMouseButton(0) && SandboxSelectionSet.SelectionFollowsMouse())
            {
